...
export function useControl<T, U = T>(options?: Options<T, U>) {
  ...
  /**
   * directly use onChange as return value will cause error and no dts file emitted:
   *
   * @npcs/ui:compile:watch: (!) [plugin typescript] src/hooks/control.ts (4:17): @rollup/plugin-typescript TS4058: Return type of exported function has or is using name 'EventTarget' from external module "/Users/wangshouren/workspace/private/npcs/node_modules/.pnpm/ahooks@3.8.4_react@19.0.0/node_modules/ahooks/lib/useEventTarget/index" but cannot be named.
   */
  return [
